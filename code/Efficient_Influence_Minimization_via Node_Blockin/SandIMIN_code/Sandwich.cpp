...
void Run(int argn, char **argv)
{
    ...
    arg.res = "results/res_" + temp_name + "_|S|=" + to_string(arg.Rumor_num) + "_K=" + to_string(arg.k) + "_epsilon=" + to_string(arg.epsilon) + "_gamma=" + to_string(arg.gamma) + "_beta=" + to_string(arg.beta) + "_algo=" + arg.algo;
